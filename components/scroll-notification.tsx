...
export default function ScrollNotification({ direction, pageName }: ScrollNotificationProps) {
  ...
  return (
    <motion.div
      className={`fixed bottom-10 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 rounded-full ${currentTheme.activeBg} px-4 py-3 text-white shadow-lg backdrop-blur-sm`}
