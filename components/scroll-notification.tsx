...
export default function ScrollNotification({ direction, pageName }: ScrollNotificationProps) {
  ...
  return (
    <motion.div
      className="fixed bottom-10 left-1/2 -translate-x-1/2 z-50 flex items-center gap-4 rounded-full bg-slate-900/80 px-6 py-3 text-white shadow-lg backdrop-blur-sm"
