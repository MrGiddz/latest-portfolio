...
const AboutContent = () => (
  <div className="space-y-6 text-gray-600 dark:text-gray-300 leading-relaxed">
    ...
    <p>
      Recent work includes <Highlight>SaaS platforms</Highlight>,{" "}
      <Highlight>utility tools</Highlight>,{" "}
      <Highlight>education products</Highlight>, marketplace apps,
      <Highlight> AI-assisted media tools</Highlight>, and business management
      systems for HR, church operations, commerce, and content teams.
    </p>
    <p>
